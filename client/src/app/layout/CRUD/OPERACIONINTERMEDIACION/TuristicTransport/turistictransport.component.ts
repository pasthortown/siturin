...
export class TuristicTransportComponent implements OnInit {
   ...
   toCSV() {
      this.turistic_transportDataService.get().then( r => {
         ...
         let output = 'id;ruc;tax_payer_type_id;register_code;register_date;social_name;register_id\n';
         backupData.forEach(element => {
            output += element.id; + element.ruc + ';' + element.tax_payer_type_id + ';' + element.register_code + ';' + element.register_date + ';' + element.social_name + ';' + element.register_id + '\n';
         });
