...
selectKitchenType(kitchenType: KitchenType) {
      ...
      this.registerABDataService.get_register_data(this.registerMinturSelected.register.id).then( registerDataIncomming => {
         this.establishmentDataService.get_filtered(this.registerMinturSelected.establishment.id).then( r2 => {
            ...
            this.registerTypeImageDataService.get_by_register_type(myClassificationID).then( rti => {
               ...
               const unica = 'data:image/png;base64,';
  ...
  pruebaCertificadoTurismo(cuantos: number, myClassificationID: number) {
     let today = new Date();
     let unica = true;
     this.registerTypeImageDataService.get_by_register_type(myClassificationID).then( rti => {
      const nada = 'data:image/png;base64,';
      const unica = 'data:image/png;base64,';
      let c1 = 'data:' + rti.register_type_image_file_type + ';base64,' + rti.register_type_image_file;
      let c2 = 'data:' + rti.register_type_image_file_type + ';base64,' + rti.register_type_image_file;
      let c3 = 'data:' + rti.register_type_image_file_type + ';base64,' + rti.register_type_image_file;
      let c4 = 'data:' + rti.register_type_image_file_type + ';base64,' + rti.register_type_image_file;
      ...
      const params = [{canton: 'QUITO'},
         {fecha: today.toLocaleDateString().toUpperCase()},
         {numero_registro: '1720364049.001.0000001'},
         {razon_social: 'LSYSTEMS'},
         {nombre_comercial: 'LSYSTEMS'},
         {actividad: 'ALIMENTOS Y BEBIDAS'},
         {categoria: '5 TENEDORES'},
         {clasificacion: 'RESTAURANTE'},
         {representant_legal: 'LUIS ALFONSO SALAZAR VACA'},
         {ruc: '1720364049'},
         {zonal: 'CZ2'},
         {provincia: 'PICHINCHA'},
         {parroquia: 'EL INCA'},
         {dirección: 'LOS ROBLES E14-16 Y CARDOS'},
         {mesas: 5},
         {plazas: 4},
         {c1: c1},
         {c2: c2},
         ...
         {c5: c5},
         {qrcode: '**main_qr_code**'},
         {nombre_coordinador_Zonal: 'LUIS ALFONSO SALAZAR VACA'}];
      let document = new Documento();
      document.activity = 'ALIMENTOS Y BEBIDAS';
      document.code = 'Registro de Turismo';
      document.document_type = 'REGISTRO TURÍSTICO';
      let paramsToBuild = {
         template: 1, qr: true, qr_value: 'Registro de Turismo', params: params
      };
      document.procedure_id = 'REGISTRO';
      document.zonal = 'COORDINACIÓN ZONAL 2';
      document.user = 'CZ2';
      document.params = JSON.stringify(paramsToBuild);
      this.documentDataService.post(document).then().catch( e => { console.log(e); });
      this.exporterDataService.template(15, true, 'Registro de Turismo', params).then( r => {
         const byteCharacters = atob(r);
         const byteNumbers = new Array(byteCharacters.length);
         for (let i = 0; i < byteCharacters.length; i++) {
            byteNumbers[i] = byteCharacters.charCodeAt(i);
         ...
         const byteArray = new Uint8Array(byteNumbers);
         const blob = new Blob([byteArray], { type: 'application/pdf'});
         saveAs(blob, 'Registro de Turismo' + '.pdf');
         this.imprimiendo_registro = false;
      }).catch( e => { console.log(e); });
   }).catch( e => { console.log(e); });
  }
